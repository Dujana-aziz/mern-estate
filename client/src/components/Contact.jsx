        ...
        <>
            {landLord && (
                <div className="flex flex-col gap-2">
                    ...
                    <textarea placeholder='Enter your message here' className='w-full border p-3 rounded-lg' name="message" id="message" rows="2" value={message} onChange={onChange}></textarea>
